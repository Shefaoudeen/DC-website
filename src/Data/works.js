const works = [
  ...
  {
    title: "Rejouir-Pecofes. ",
    link: "https://www.instagram.com/rejouir_ptu/",
    description:
      "Rejouir, formerly known as Pecofes, is the annual university festival that celebrates creativity, talent, and community spirit. For the past three years, every aspect of the festival, including posters, invitations, banners, mementos, and more, has been meticulously designed by Devanathan, Vice President, and Shrikaanth from Prime Unit. Their creative vision and dedication have played a significant role in making Rejouir a memorable and successful event.",
  },
  {
    title: "Neura 2023. ",
    link: "https://www.instagram.com/neura2k23/",
    description:
      "Neura, a national-level symposium held in March 2023, was organized by the Department of Information Technology at PTU. The event was meticulously designed by a collaborative team including Kuhan, President, Yoge from Prime Unit, and Balaji, Navin, Santhosh, and Cyrill from the IT department. This dedicated team was responsible for designing everything from posters, invitations, banners to mementos, ensuring a visually appealing and well-coordinated event.",
  },
  {
    title: "PTU Intro. ",
    link: "",
  ...
  {
    title: "DC Pamphlet. ",
    link: "https://drive.google.com/drive/folders/1P_eMgcaMJnElrqK-elIolXToXa16du3_?usp=sharing",
    description:
      "The DC (Design Club) pamphlet, introducing various units of DC, has been meticulously crafted by Kuhan, President, in honor of World Design Day on April 27. The pamphlet features a minimalist design, centered around the concept of a lone wolf, symbolizing its independent and innovative spirit. Using a monochrome palette with various shades, the design emphasizes simplicity and elegance.",
  },
  {
    title: "PTU Website. ",
...

  {
    ...
    description:
      "The Design Club, established in 2019, has grown over the years with the contributions of various club members. Together, they have made significant contributions to projects such as the PTU website, Rejouir, calendars, and more. Explore all our works on the university website and witness the creative journey of the Design Club.",
  },
];
