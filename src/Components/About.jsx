...
const About = () => {
  return (
    <div className="bg-[#005cef] w-full h-screen flex justify-start items-start max-sm:text-6xl">
      <div className="flex flex-col justify-center w-[100%] max-sm:w-[90%] z-50 home-custom-2 pt-20">
